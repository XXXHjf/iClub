...
public class getSTS {
    public static void main(String[] args) throws Exception {
        ...
        StaticCredentialProvider provider = StaticCredentialProvider.create(Credential.builder()
                .accessKeyId(System.getenv("LTAI5tJgrjDHXonS6Rpg5bfZ"))
                .accessKeySecret(System.getenv("DfFbTNNTvTqapENn2CLt4Mt2pSKmxe"))
//                .securityToken(System.getenv("SECURITY_TOKEN")) // use STS token
        ...
        AssumeRoleRequest assumeRoleRequest = AssumeRoleRequest.builder()
                .roleArn("acs:ram::1523797251992087:role/ramosstest")
                .roleSessionName("test01")
                .externalId("")
                .policy("")
